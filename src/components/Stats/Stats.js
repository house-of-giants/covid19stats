...
const Stats = ({ url }) => {
	...
	return (
		<div className="py-2">
			<h1 className="text-5xl py-2">COVID-19 World Stats</h1>
			...
			<div className="grid grid-cols-4 gap-2 text-xl md:text-3xl items-center bg-gray-200 hover:bg-gray-400 py-4 px-6 border-b border-l border-r border-gray-400">
				<p>{confirmed.value}</p>
				<p>{deaths.value}</p>
				<p>{recovered.value}</p>
